/* 주제: Property 에디터를 사용하여 입력 값 다루기
...
//       문자열을 Date 객체로 만든다.
  ...
  protected void initBinder(WebDataBinder binder) {
      ...
      dateFormat.setLenient(false);//Lenient: 관대한 ; -> false면 관대하지마라-> 즉 문법 엄격!
      
//      String --> Date 타입의 값으로 바꿀 때
//      CustomDateEditor를 사용하여 바꾸라는 의미이다.
      binder.registerCustomEditor(Date.class, new CustomDateEditor(dateFormat, false));//에디터를 사용해서 Date객체로 변경
  }
